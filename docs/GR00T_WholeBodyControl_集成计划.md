...
- **encoder mode 切换验证**（下一步探针）：试 mode_id=1（teleop）/2（smpl），最快排除法。g1=0 baseline absmax step1=2.56，zero_body=1.97，teleop=1.64（更低）—— **encoder mode 也不是根因**，mode 1 step1 更低但仍爆炸到 17.9
