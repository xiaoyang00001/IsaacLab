...
class Articulation(AssetBase):
    ...
    def instantaneous_wrench_composer(self) -> WrenchComposer:
        ...
        Wrenches added or set to this composer are only valid for the current simulation step.
        At the end of the step, they are discarded.
        """
    ...
    def permanent_wrench_composer(self) -> WrenchComposer:
        ...
        Wrenches added or set to this composer are persistent and applied every step.
        """
    ...
    def _create_buffers(self):
        ...
        # PhysX supports is_global=True; Newton (3.0+) will set this to False
