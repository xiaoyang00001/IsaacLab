...
抱取演示物体（HugBox，与 SonicSolo 同源导入）。
...
from .sonic_solo_locomanipulation_env_cfg import HUG_BOX_CFG, HUG_BOX_STAND_CFG, ROBOT_SPAWN_POS


@configclass
class SonicFullsceneSceneCfg(_main.LocomanipulationG1SceneCfg):
    """主场景 + warehouse 背景 + 打包台道具 + 抱取演示物体。"""
    ...
    # 抱取演示物体（与 SonicSolo 同源；位于机器人出生点正前方 1.05m 行走通道上，
    # 距传送带 y 向 4m+，无碰撞）
