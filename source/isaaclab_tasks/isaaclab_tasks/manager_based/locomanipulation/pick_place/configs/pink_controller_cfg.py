...
G1_UPPER_BODY_IK_ACTION_CFG = PinkInverseKinematicsActionCfg(
    ...
    waist_yaw_source="head",
    waist_yaw_task_indices=(0, 1),
    waist_yaw_primary_task_index=1,
    waist_yaw_lateral_axis=1,
    waist_yaw_direction=1.0,
    waist_yaw_head_gain=1.0,
    waist_yaw_deadzone=0.06,
    waist_yaw_release_deadzone=0.03,
    waist_yaw_scale=1.0,
    waist_yaw_max_angle=1.57,
    waist_yaw_signal_smoothing=0.35,
    waist_yaw_turn_smoothing=0.85,
    waist_yaw_return_smoothing=0.12,
    waist_yaw_max_step=0.20,
    asset_name="robot",
