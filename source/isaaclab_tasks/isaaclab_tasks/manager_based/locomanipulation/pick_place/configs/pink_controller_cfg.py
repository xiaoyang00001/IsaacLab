...
G1_UPPER_BODY_IK_ACTION_CFG = PinkInverseKinematicsActionCfg(
    ...
    waist_yaw_deadzone=0.04,
    waist_yaw_release_deadzone=0.02,
    waist_yaw_scale=4.5,
    waist_yaw_max_angle=0.7,
    waist_yaw_signal_smoothing=0.05,
    waist_yaw_turn_smoothing=0.5,
    waist_yaw_return_smoothing=0.16,
    waist_yaw_max_step=0.05,
)