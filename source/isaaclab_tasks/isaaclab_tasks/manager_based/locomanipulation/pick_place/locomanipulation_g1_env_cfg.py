...
# Keep the comparison scene's three boxes physically identical to the UDP scene.
...
def _box_cfg(
    ...
    """Create a box with the same physical and visual properties as the UDP scene."""
...
class LocomanipulationG1SceneCfg(InteractiveSceneCfg):
    ...
    # Keep the first small box under the scene key ``object`` because the
    # official observations and terminations access ``env.scene["object"]``.
    object = _box_cfg(
        prim_name="SmallBox1",
        size=SMALL_BOX_SIZE,
