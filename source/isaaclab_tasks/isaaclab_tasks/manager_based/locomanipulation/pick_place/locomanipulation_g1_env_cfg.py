...
# Match GR00T/MuJoCo's per-joint motor limits and reflected armatures, while
# using position-servo gains suited to this task's target-only arm control path
# (no MuJoCo/WBC torque feed-forward or gravity compensation is applied here).
