...
# ---------- CUDA 库冲突防护（勿删，与 start_teleop_g1.sh 同款） ----------
...
_conda_prefix="${CONDA_PREFIX:-${HOME}/miniconda3/envs/env_isaaclab}"
NVJITLINK="${_conda_prefix}/lib/python3.11/site-packages/nvidia/nvjitlink/lib/libnvJitLink.so.12"
